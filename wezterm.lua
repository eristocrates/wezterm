...
config.color_schemes                = {
  ['ow-the-edge'] = {
    ...
    copy_mode_active_highlight_bg = { Color = death_by_chocolate },
    -- use `AnsiColor` to specify one of the ansi color palette values
    -- (index 0-15) using one of the names "Black", "Maroon", "Green",
    --  "Olive", "Navy", "Purple", "Teal", "Silver", "Grey", "Red", "Lime",
    -- "Yellow", "Blue", "Fuchsia", "Aqua" or "White".
    copy_mode_active_highlight_fg = { Color = dwarf_fortress },
    copy_mode_inactive_highlight_bg = { Color = intergalactic },
    copy_mode_inactive_highlight_fg = { Color = hint_of_red },
